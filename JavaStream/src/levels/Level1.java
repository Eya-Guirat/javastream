...
public class Level1 {
    ...
    public static void main(String[] args) {
         ...
         */
        teachers.stream().filter(teacher -> teacher.getName().toLowerCase().startsWith("m")).peek(teacher -> teacher.setSalary(teacher.getSalary() + 200)).max((t1, t2) -> Integer.compare(t1.getSalary(), t2.getSalary())).ifPresent(System.out::println);
